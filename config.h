...
static char *font2[] = { "Noto Color Emoji:pixelsize=12:antialias=true:autohint=true", "FontAwesome:size=10:antialias=false:autohint=true", "Noto Sans Mono CJK JP:size=10:antialias=false:autohint=true", "UbuntuMono-R:size=10:antialias=false:autohint=true"};
